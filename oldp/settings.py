...
class BaseConfiguration(Configuration):
    ...
    DJANGO_MCP_GLOBAL_SERVER_CONFIG = {
        ...
        "instructions": (
            ...
            "Use get_case / get_law_section to retrieve the complete text. For "
            "long documents pass offset and/or length to read a plain-text "
            "snippet (character positions in plain text, not HTML) and continue "
